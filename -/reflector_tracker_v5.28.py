...
class CalibrationData:
    ...
    def __init__(self):
        ...
        self.ir_stationary_deadband = 0.25
    ...
    def _update_track(
        ...
        if needs_ir_confirmation:
            ...
            if detection is not None and ir_anchor is not None:
                ...
                # каждого рабочего измерения. Если поправка не была надежно
                # измерена, оставляем HOLD в верной точке вместо скачка.
...
class ReflectorApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Система устойчивого отслеживания отражателей v5.28")
...
"""
    ...
    def _show_about(self):
        messagebox.showinfo(
            "О программе",
            "Система обнаружения отражателей v5.28\n\n"
    ...
    def _initialize_ir_tracking_models(self):
        ...
        for index, region in enumerate(self.calibration.peak_regions):
            ...
            if detection is None:
                ...
                model["tracking_offset_valid"] = False
                continue
            center_offset = (
